...
export const checkSessionValidity = () => API.get(`http://localhost:5001/api/checkSession/`);
export const checkUser = (encodedEmail) => API.get(`http://localhost:5001/api/checkUser?email=${encodedEmail}`);
export const recoverPass = (id, data) => API.post('http://localhost:5001/api/recoverPassword', {id, data});
